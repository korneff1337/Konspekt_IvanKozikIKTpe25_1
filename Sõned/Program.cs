...
namespace Sõned
{
    internal class Program
    {
        ...
        {
            string lause = "tere kuidas läheb?";
            ////Console.WriteLine("lause pikkus on: " +lause.Length);
            ////Console.WriteLine("See tekst on capslockis: " + lause.ToUpper());
            ////Console.WriteLine("See tekst on väiketäthtedes: " + lause.ToLower());
            ////Console.WriteLine("Kas lasuses on sõna \"Tere\"?:" + lause.ToLower().Contains("Tere"));
